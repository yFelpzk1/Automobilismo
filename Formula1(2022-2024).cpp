...
void Contar_Pontos(Formula1 *pPiloto) {
    float pontosPiloto = pPiloto->pontosPiloto + (pPiloto->Corridas * 26) + (pPiloto->Sprints * 8);
    float pontosConstrutor = pPiloto->pontosConstrutor + (pPiloto->Corridas * 44) + (pPiloto->Sprints * 15);

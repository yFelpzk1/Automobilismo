...
void Contar_Pontos(Formula1 *pPiloto) {
    float pontosPiloto = pPiloto->pontosPiloto + (pPiloto->Corridas * 25) + (pPiloto->Sprints * 8);
    float pontosConstrutor = pPiloto->pontosConstrutor + (pPiloto->Corridas * 43) + (pPiloto->Sprints * 15);
